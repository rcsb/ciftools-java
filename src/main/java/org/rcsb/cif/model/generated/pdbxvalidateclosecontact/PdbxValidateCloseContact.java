package org.rcsb.cif.model.generated.pdbxvalidateclosecontact;
...
public class PdbxValidateCloseContact extends BaseCategory {
     ...
     * @return SymmAsXyz1
     */
    public SymmAsXyz1 getSymmAsXyz1() {
        return (SymmAsXyz1) (isText ? textFields.computeIfAbsent("symm_as_xyz_1",
                SymmAsXyz1::new) : getBinaryColumn("symm_as_xyz_1"));
    }
     ...
     * @return SymmAsXyz2
     */
    public SymmAsXyz2 getSymmAsXyz2() {
        return (SymmAsXyz2) (isText ? textFields.computeIfAbsent("symm_as_xyz_2",
                SymmAsXyz2::new) : getBinaryColumn("symm_as_xyz_2"));
    }
