package org.rcsb.cif.model.generated.pdbxdistantsolventatoms;
...
public class PdbxDistantSolventAtoms extends BaseCategory {
     ...
     */
    public NeighborMacromoleculeDistance getNeighborMacromoleculeDistance() {
        return (NeighborMacromoleculeDistance) (isText ? textFields.computeIfAbsent("neighbor_macromolecule_distance",
                NeighborMacromoleculeDistance::new) : getBinaryColumn("neighbor_macromolecule_distance"));
    }
     ...
     */
    public NeighborLigandDistance getNeighborLigandDistance() {
        return (NeighborLigandDistance) (isText ? textFields.computeIfAbsent("neighbor_ligand_distance",
                NeighborLigandDistance::new) : getBinaryColumn("neighbor_ligand_distance"));
    }
}
