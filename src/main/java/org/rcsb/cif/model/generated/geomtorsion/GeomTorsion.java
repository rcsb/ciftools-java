...
public class GeomTorsion extends BaseCategory {
     ...
     */
    public PdbxAtomSitePDBInsCode4 getPdbxAtomSitePDBInsCode4() {
        return (PdbxAtomSitePDBInsCode4) (isText ? textFields.computeIfAbsent("pdbx_atom_site_PDB_ins_code_4",
                PdbxAtomSitePDBInsCode4::new) : getBinaryColumn("pdbx_atom_site_PDB_ins_code_4"));
    }
