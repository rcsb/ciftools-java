...
public class Citation extends DelegatingCategory.DelegatingCifCoreCategory {
    ...
    public StrColumn getAbstractIdCAS() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_abstract_id_CAS"));
    }
    ...
    public StrColumn getBookIdISBN() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_book_id_ISBN"));
    }
    ...
    public StrColumn getBookPublisher() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_book_publisher"));
    }
    ...
    public StrColumn getBookPublisherCity() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_book_publisher_city"));
    }
    ...
    public StrColumn getBookTitle() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_book_title"));
    }
    ...
    public StrColumn getCoordinateLinkage() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_coordinate_linkage"));
    }
    ...
    public StrColumn getCountry() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_country"));
    }
    ...
    public StrColumn getDatabaseIdCSD() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_database_id_CSD"));
    }
    ...
    public StrColumn getDatabaseIdMedline() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_database_id_Medline"));
    }
    ...
    public StrColumn getDoi() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_doi"));
    }
    ...
    public StrColumn getJournalAbbrev() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_journal_abbrev"));
    }
    ...
    public StrColumn getJournalFull() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_journal_full"));
    }
    ...
    public StrColumn getJournalIdASTM() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_journal_id_ASTM"));
    }
    ...
    public StrColumn getJournalIdCSD() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_journal_id_CSD"));
    }
    ...
    public StrColumn getJournalIdISSN() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_journal_id_ISSN"));
    }
    ...
    public StrColumn getPublisher() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_publisher"));
    }
