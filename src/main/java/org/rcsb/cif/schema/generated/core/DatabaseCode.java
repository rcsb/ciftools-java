...
public class DatabaseCode extends DelegatingCategory.DelegatingCifCoreCategory {
    ...
    public StrColumn getCAS() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_CAS"));
    }
    ...
    public StrColumn getCOD() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_COD"));
    }
    ...
    public StrColumn getCSD() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_CSD"));
    }
    ...
    public StrColumn getDepnumCcdcArchive() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_depnum_ccdc_archive"));
    }
    ...
    public StrColumn getDepnumCcdcFiz() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_depnum_ccdc_fiz"));
    }
    ...
    public StrColumn getDepnumCcdcJournal() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_depnum_ccdc_journal"));
    }
    ...
    public StrColumn getICSD() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_ICSD"));
    }
    ...
    public StrColumn getMDF() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_MDF"));
    }
    ...
    public StrColumn getNBS() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_NBS"));
    }
    ...
    public StrColumn getPDB() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_PDB"));
    }
    ...
    public StrColumn getPDF() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_PDF"));
    }
}
