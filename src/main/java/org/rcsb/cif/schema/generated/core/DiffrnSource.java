...
public class DiffrnSource extends DelegatingCategory.DelegatingCifCoreCategory {
     ...
     * @return StrColumn
     */
    public StrColumn getCurrent() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_current"));
    }
     ...
     * @return StrColumn
     */
    public StrColumn getPower() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_power"));
    }
     ...
     * @return StrColumn
     */
    public StrColumn getTakeOffAngle() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_take_off_angle"));
    }
     ...
     * @return StrColumn
     */
    public StrColumn getVoltage() {
        return new DelegatingStrColumn(parentBlock.getColumn(NAME + "_voltage"));
    }
}
