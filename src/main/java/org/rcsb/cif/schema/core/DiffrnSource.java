...
public class DiffrnSource extends DelegatingCategory.DelegatingCifCoreCategory {
    ...
    public StrColumn getDescription() {
        return new DelegatingStrColumn(parentBlock.getColumn("diffrn_source_description"));
    }
    ...
    public StrColumn getMake() {
        return new DelegatingStrColumn(parentBlock.getColumn("diffrn_source_make"));
    }
    ...
    public FloatColumn getTakeOffAngle() {
        return new DelegatingFloatColumn(parentBlock.getColumn("diffrn_source_take_off_angle"));
    }
