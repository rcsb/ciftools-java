...
public class MaPolyResidueFeature extends DelegatingCategory {
    public MaPolyResidueFeature(Category delegate) {
        super(delegate);
    }
    ...
    /**
     * An identifier for the selected residue feature.
    ...
    /**
     * An asym/strand identifier for the residue feature.
    ...
    /**
     * The component identifier for the residue feature.
    ...
    /**
     * The sequence index of the residue feature.
